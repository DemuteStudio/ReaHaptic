...
local host, port = "localhost", 7401
-- convert host name to ip address
local ip = "172.18.208.1"
-- create a new UDP object
local udp = assert(socket.udp())

-- Encoding some cool messages to send via OSC 
local msg1 = osc.encode('/track 1/fx parameters', 666)-- encoding osc message with the address `/track 1/fx parameters` the values are a random integer, a flot and a string
